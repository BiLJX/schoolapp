...
exports.getStudentsAssignmentPerformance = exports.getStudentMDOverall = exports.getStudentDemeritsPerformance = exports.getStudentMeritsPerformance = void 0;
...
var getStudentMeritsPerformance = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var jsonResponse, periods, time_period, user_id, agg, group, merits, performance_data, error_1;
...
var getStudentDemeritsPerformance = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var jsonResponse, periods, time_period, user_id, agg, group, demerits, performance_data, error_2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                jsonResponse = new Response_1.default(res);
...
var getStudentMDOverall = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var jsonResponse, user_id, total_interactions, merits_sum, demerits_sum, _i, total_interactions_1, x, ratio, difference, error_3;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                jsonResponse = new Response_1.default(res);
...
var getStudentsAssignmentPerformance = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var jsonResponse, user_id_1, student, assignments, assignment_logs, completed_assignments, pending_assignments, assignment_ratio, total_assignment_points, data, error_4;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                jsonResponse = new Response_1.default(res);
            ...
            case 1:
                ...
                return [4 /*yield*/, Student_1.Students.findOne({ user_id: user_id_1 })];
            case 2:
                student = _a.sent();
                if (!student)
                    return [2 /*return*/, jsonResponse.clientError("student not found: (")];
                return [4 /*yield*/, Assignment_1.Assignments.find({ assigned_class: { $in: [student.class_id] } }).lean()];
            case 3:
                assignments = _a.sent();
                if (!assignments)
                    return [2 /*return*/, jsonResponse.clientError("No assignments found")];
                return [4 /*yield*/, Assignment_1.AssignmentLog.find({ log_of: user_id_1, type: "completed" })];
            case 4:
                assignment_logs = _a.sent();
                completed_assignments = assignments.filter(function (x) { return x.completed_by.includes(user_id_1); });
                pending_assignments = assignments.filter(function (x) { return !x.completed_by.includes(user_id_1); });
                assignment_ratio = completed_assignments.length / assignments.length;
                total_assignment_points = assignment_logs.reduce(function (points, assignment) { return assignment.points_gained + points; }, 0);
                data = [
                    {
                ...
                return [2 /*return*/, jsonResponse.success(data)];
            case 5:
                error_4 = _a.sent();
                console.log(error_4);
                jsonResponse.serverError();
...
exports.getStudentsAssignmentPerformance = getStudentsAssignmentPerformance;
