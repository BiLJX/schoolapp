...
var AdminAuth = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var jsonResponse, session, verified, school_id, school, err_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.trys.push([1, 3, , 4]);
                session = req.cookies.session || req.headers.session;
                if (!session)
                    return [2 /*return*/, jsonResponse.notAuthorized()];
                verified = jsonwebtoken_1.default.verify(session, secret_1.SCHOOL_PASSWORD_SECRET);
                school_id = verified.school_id;
                return [4 /*yield*/, School_1.Schools.findOne({ school_id: school_id }).select('-password')];
            case 2:
                school = _a.sent();
                if (!school)
                    return [2 /*return*/, jsonResponse.notAuthorized()];
